...
//     if (toggle) newQueue.add(sourceTwo.remove());
//     else newQueue.add(sourceOne.remove());

//     toggle = !toggle;
//   }
//   if (sourceOne.peek() !== undefined) {
//     while (sourceOne.peek() !== undefined) newQueue.add(sourceOne.remove());
//   } else if (sourceTwo.peek() !== undefined) {
//     while (sourceTwo.peek() !== undefined) newQueue.add(sourceTwo.remove());
//   }
